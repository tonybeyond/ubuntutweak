...
install_other_packages () {
    local packages=("fish" "gnome-tweaks" "btop" "hyfetch" "flameshot" "xclip" "gimagereader" "tesseract-ocr" "tesseract-ocr-fra" "tesseract-ocr-eng" "gnome-shell-extension-appindicator" "gnome-shell-extension-manager" "curl" "wget" "build-essential" "neovim" "node-typescript" "bat" "exa" "nala" "vlc" "dconf-editor")
